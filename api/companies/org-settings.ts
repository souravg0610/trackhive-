...
export default async function(req: VercelRequest, res: VercelResponse) {
  ...
  if (req.method === 'PUT' || req.method === 'PATCH') {
    ...
    if (b.rolePermissions) u.role_permissions = b.rolePermissions;
    if (b.customRoles) u.custom_roles = b.customRoles;
    if (b.customDepartments) u.custom_departments = b.customDepartments;
    if (b.customBranches) u.custom_branches = b.customBranches;
